/*
*   File Name:      categoryWheel.java
*   Author:         Tejas Dwarkaram
*   Description:    Creating the class that will do the rotation
*                   of the wheel image that will be used to choose
 *                  a category
*
*
*/
...
public class categoryWheel extends ImageView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (wheelHeight == 0 || wheelWidth == 0) {
            ...
            categoryWheel.this.setImageBitmap(imageScaled);
            categoryWheel.this.setImageMatrix(matrix);
        }
    }
